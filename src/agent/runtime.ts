...
const PROFILES: Record<BuildMode, BuildModeProfile> = {
  "full-agent": {
    ...
    idleLines: [
      "Clara astronaut idle.",
      "Clara orbit ready.",
      "Clara floating near the build.",
    ],
    playfulLines: [
      "Clara spin.",
      "Clara wave.",
