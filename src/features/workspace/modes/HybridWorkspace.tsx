...
import { type AgentAction, type AgentLiveItem, type ExplorerItem, type FileBuffer } from "../../../shared/types";
      ...
      {showAssistPane && (
        <>
          ...
          <aside className="hybridSidePane hybridAssistRail" style={{ width: assistPaneWidth }}>
            <div className="assistRailHeader">
              <div>
                <div className="assistRailEyebrow">Run desk</div>
                <div className="assistRailTitle">Agent + preview</div>
              </div>
              <button className="assistRailRunButton" type="button" onClick={onEnsurePreviewRunning} disabled={!ws}>
                Run
              </button>
            </div>
            {hasInteractionItems ? (
              <div className="missionCard hybridInteractionCard">
                <div className="missionCardHeader">
                  <div>
                    <div className="missionCardEyebrow">Trace</div>
                    <div className="missionCardTitle">Agent activity</div>
                  </div>
                </div>
              ...
              <div className="missionCard hybridInteractionCard quiet">
                <div className="missionCardHeader">
                  <div>
                    <div className="missionCardEyebrow">Trace</div>
                    <div className="missionCardTitle">No active run</div>
                  </div>
                </div>
              </div>
            )}
