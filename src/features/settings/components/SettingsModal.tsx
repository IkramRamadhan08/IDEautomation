      ...
      <div className="modalCard pane" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="settingsGrid compactSettingsGrid">
          ...
          <div className="settingsSection">
            ...
            {isLocalNineRouter ? (
              <div className="settingsSubtle compactHint">
                Local endpoint hanya works kalau backend Appora jalan di mesin yang sama. Kalau Appora backend hosted, pakai 9Router tunnel atau URL 9Router yang reachable dari backend.
              </div>
            ) : null}
